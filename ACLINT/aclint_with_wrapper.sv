...
module tb_aclint_with_wrapper;
    ...
    task read_clint(input [31:0] offset, output [7:0] value);
        begin
            @(posedge clk);
            mem_read    = 1;
            mem_write   = 0;
            ...
            @(posedge clk);
            value = data_out;
            $display("[READ1] addr=%h data=%0d", offset, value);
            @(posedge clk);
            value = data_out;
            $display("[READ2] addr=%h data=%0d", offset, value);
            @(posedge clk);
            value = data_out;
            $display("[READ3] addr=%h data=%0d", offset, value);
            @(posedge clk);
            value = data_out;
            $display("[READ4] addr=%h data=%0d", offset, value);
            @(posedge clk);
            value = data_out;
            $display("[READ5] addr=%h data=%0d", offset, value);
            @(posedge clk);
            value = data_out;
            $display("[READ6] addr=%h data=%0d", offset, value);
            @(posedge clk);
            value = data_out;
            $display("[READ7] addr=%h data=%0d", offset, value);
            @(posedge clk);
            value = data_out;
            $display("[READ8] addr=%h data=%0d", offset, value);
            @(posedge clk);
            mem_read = 0;
